 ...
 * Adapted to run under Mootools dec 2013
 *
 * This plugin is an alpha version.
 *
 * To activate the plugin you must specify the parameter "order" for the specific serie:
 *
 *     flot.plot(placeholderElement, [{ data: [ ... ], bars: { order = null or integer }])
 *
 ...
 */
 ...
 /*
* INFO: 
* decalage/decallage is French for gap. 
* It's used to denote the spacing applied to each bar.
* 
*/
