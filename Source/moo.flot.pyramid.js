...
authors:
  - @asis (https://github.com/asis/flot-pyramid) - plugin author
...
var FlotPyramid = (function(){
  ...
  function processRawData(plot, series, datapoints) {
    ...
    series.data = Array.clone(series.data || []);
   // series.data = $.extend(true, [], series.data); - original
  ...
  function allTicksPresent(data, yaxisTicks) {
    ...
    expected_labels = yaxisTicks.map(function(e) { return e[1] });
    labels = data.map(function(e) { return e[0] });
